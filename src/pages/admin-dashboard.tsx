            ...
            <div className="flex flex-shrink-0 items-center ml-auto">
              <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
                ...
                <span className="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
                  <Image src="/images/82.jpg" width={100} height={100} alt="user profile photo" className="h-full w-full object-cover"/>
                </span>
                  ...
                  <ul className="p-6 space-y-6">
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <Image src="/images/82.jpg" width={100} height={100} alt="Annette Watson profile picture"/>
                      </div>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <Image src="/images/82.jpg" width={100} height={100}   alt="Calvin Steward profile picture"/>
                      </div>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <Image src="/images/82.jpg" width={100} height={100}  alt="Ralph Richards profile picture"/>
                      </div>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <Image src="/images/82.jpg" width={100} height={100}  alt="Bernard Murphy profile picture"/>
                      </div>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <Image src="/images/82.jpg" width={100} height={100} alt="Arlene Robertson profile picture"/>
                      </div>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <Image src="/images/82.jpg" width={100} height={100} alt="Jane Lane profile picture"/>
                      </div>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <Image src="/images/82.jpg" width={100} height={100} alt="Pat Mckinney profile picture"/>
                      </div>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <Image src="/images/82.jpg" width={100} height={100} alt="Norman Walters profile picture"/>
                      </div>
